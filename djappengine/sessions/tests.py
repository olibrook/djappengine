...
from djappengine.sessions.backends import cached_db
from djappengine.sessions.backends.cached_db import SessionStore as CacheDBSession
from djappengine.sessions.backends.db import SessionStore as DatabaseSession
from djappengine.sessions.mapper import DeleteMapper
from djappengine.sessions.middleware import SessionMiddleware
...
class SessionCleanUpTest(TestCase):
    ...
    def test_view(self):
        ...
        c = Client()
        response = c.get('/djappengine/sessions/clean-up/')
